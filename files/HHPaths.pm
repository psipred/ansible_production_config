...
our $execdir = "/data/psipred/bin";  # path to PSIPRED V2 binaries
our $datadir = "/data/psipred/data"; # path to PSIPRED V2 data files
our $ncbidir = "/data/blast-2.2.26/bin";    # path to NCBI binaries (for PSIPRED in addss.pl)
